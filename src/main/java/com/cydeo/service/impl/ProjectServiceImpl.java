...
public class ProjectServiceImpl implements ProjectService {
    ...
    public List<ProjectDTO> listAllProjectDetails() {
        ...
        String username = SecurityContextHolder.getContext().getAuthentication().getName();//security bring info who is login in the system

        UserDTO currentUserDTO = userService.findByUserName(username);//for not hardCoded - security will catch name who is login
